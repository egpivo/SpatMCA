...
test_that("Selected tuning parameters", {
  expect_lte(abs(cv_1D$stau1u - 0.1700728), tol)
  expect_lte(abs(cv_1D$stau2u - 1.125673), tol)
  expect_lte(abs(cv_1D$stau1v - 0.1569319), tol)
  expect_lte(abs(cv_1D$stau2v - 1.013889), tol)
